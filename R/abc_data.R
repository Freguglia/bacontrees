...
#' @rdname abc_data
#'
#' @description The data objects `abc_vec` and `abc_list` contain sequences generated using a Variable Length Markov Chain (VLMC) with a specified context tree and transition probabilities.
#'
#' @format
...
#' print(abc_list)
#'
#' @source The data was generated using the `rvlmc` function in the R package
#' \pkg{bacontrees}.
"abc_list"
